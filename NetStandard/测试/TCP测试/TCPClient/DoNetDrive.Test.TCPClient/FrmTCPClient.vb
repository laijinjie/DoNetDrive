...
Imports DoNetDrive.Common.Cryptography
...
Public Class FrmTCPClient
    ...
    Private Function GetConnectorDetail(conn As INConnectorDetail) As String
        ...
        Select Case conn.GetTypeName
            Case ConnectorType.TCPClient
                Dim dtl As TCPClientDetail_Readonly = oConn.GetConnectorDetail()
    ...
    Private Function GetTCPClientDetail() As TCPClientDetail
        ...
        If chkSSL.Checked Then
            Return New TCPClientDetail(sRemoteIP, iRemotePort, sLocalIP, iLocalPort, True, Nothing)
        Else
            Return New TCPClientDetail(sRemoteIP, iRemotePort, sLocalIP, iLocalPort)
        End If
    ...
    Private Sub butTCPClientSend_200K_Click(sender As Object, e As EventArgs) Handles butTCPClientSend_200K.Click
        ...
        Next
        Dim crc32 = CRC32_C.CalculateDigest(buf.Array, buf.ArrayOffset, ilen)
