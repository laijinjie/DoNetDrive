...
Public Class frmWebSocketClient
    ...
    Private Function GetConnectorDetail(conn As INConnectorDetail) As String
        ...
        Select Case conn.GetTypeName
            Case ConnectorType.WebSocketClient
                Dim dtl As Connector.WebSocket.Client.WebSocketClientDetail_Readonly = oConn.GetConnectorDetail()
    ...
    Private Function GetTCPClientDetail() As Connector.WebSocket.Client.WebSocketClientDetail
        ...
        If chkSSL.Checked Then
            Return New Connector.WebSocket.Client.WebSocketClientDetail(sRemoteIP, iRemotePort, sLocalIP, iLocalPort, True, Nothing)
        Else
            Return New Connector.WebSocket.Client.WebSocketClientDetail(sRemoteIP, iRemotePort, sLocalIP, iLocalPort)
        End If
